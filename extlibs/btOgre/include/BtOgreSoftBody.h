...
namespace BtOgre
{
	...
	class BtOgreSoftBody : private hydroutil::Uncopyable {
	//class BtOgreSoftBody {
	...
	public:
		...
		btSoftBody* create(Ogre::Entity *entity, const unsigned int vertexCount, const Ogre::Vector3* vertexBuffer, const unsigned int indexCount, const unsigned int* indexBuffer);
		void updateOgreMesh();
